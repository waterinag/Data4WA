...
## GSMaP Overview
Global Satellite Mapping of Precipitation (GSMaP) provides a global hourly rain rate with a 0.1 x 0.1 degree resolution. GSMaP is a product of the Global Precipitation Measurement (GPM) mission, which provides global precipitation observations at three hour intervals. Values are estimated using multi-band passive microwave and infrared radiometers from the GPM Core Observatory satellite and with the assistance of a constellation of other satellites.
...
- **Product**: GSMaP
- **Source**: [https://developers.google.com/earth-engine/datasets/catalog/JAXA_GPM_L3_GSMaP_v8_operational](https://developers.google.com/earth-engine/datasets/catalog/JAXA_GPM_L3_GSMaP_v8_operational)
- **Format**: GeoTIFF
- **Extent**: Global
- **Data Availability**: 1998-present
- **Spatial Resolution**: 11132m
...
## Download Daily GSMaP PCP

The following script downloads **daily GSMaP PCP GeoTIFFs (in mm/day)** for a given year range from Google Earth Engine:
