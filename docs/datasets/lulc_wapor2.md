# Land cover classification (Africa and Near East - Annual - 250m)
...
For further information on the methodology read the WaPOR documentation available at: [https://wapor.apps.fao.org/catalog/WaPOR_2/2/L2_LCC_A/deprecated](https://wapor.apps.fao.org/catalog/WaPOR_2/2/L2_LCC_A/deprecated)
...
- **Product**: WaPOR v2
- **Source**: [https://storage.googleapis.com/fao-gismgr-wapor-2-data/DATA/WAPOR-2/MAPSET](https://storage.googleapis.com/fao-gismgr-wapor-2-data/DATA/WAPOR-2/MAPSET)
- **Format**: GeoTIFF
- **Extent**: Africa and Near East
...
## Download Annual WaPOR v2 LULC 100m Data
